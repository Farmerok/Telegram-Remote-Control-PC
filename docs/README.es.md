...
- **🚀 Ejecutar archivos:** Abre cualquier archivo desde tu directorio.
- **📥 Subir archivos:** Sube archivos directamente a tu PC.
- **📤 Descargar archivos:** Descarga archivos desde tu PC a Telegram.
- **🗑️ Eliminar archivos y carpetas:** Elimina archivos o carpetas por nombre.
- **🔗 Descargar por enlace:** Descarga archivos a través de un enlace directo.
...
| **Linux**        | ❌              |                                                                                                                                                                              |                                                                                                                        |
| **MacOS**        | ❌              |                                                                                                                                                                              |                                                                                                                        |
| **Windows 7**    | ✔️              | 1. **Puede encontrar un error:** `api-ms-win-core-path-l1-1-0.dll`. **Descargue el archivo necesario para resolver esto.**<br>2. **Si agrega el programa al inicio, habilítelo manualmente en** `msconfig` > **Inicio.** | [Ir al enlace](https://github.com/Farmerok/Telegram-Remote-Control-PC/tree/main/docs/resource/files/for_WIndows-7)           |
