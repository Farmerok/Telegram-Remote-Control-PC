  ...
  <table>
    <tr>
      <td align="center">
        ...
        <b>🌍 Локалізація</b><br>
        Бот доступний на кількох мовах, що робить його зручним для користувачів по всьому світу.
      </td>
      <td align="center">
        <img src="resource/image/takescreenshot.png" width="290px"><br>
        <b>🖼️ Створення скріншотів</b><br>
        Робіть і отримуйте скріншоти прямо з вашого ПК.
      </td>
      <td align="center">
        <img src="resource/image/panelbot.png" width="290px"><br>
        <b>🔧 Налаштування бота</b><br>
        Легко налаштовуйте і керуйте параметрами бота.
      </td>
    </tr>
    <tr>
      <td align="center">
        <img src="resource/image/panelsystem.png" width="290px"><br>
        <b>🖥️ Панель керування системою</b><br>
        Моніторьте і керуйте процесами вашої системи.
      </td>
      <td align="center">
        <img src="resource/image/systemSection.png" width="290px"><br>
        <b>⚙️ Інформація про систему</b><br>
        Переглядайте детальну інформацію про систему, таку як завантаження процесора, статистика пам'яті і багато іншого.
      </td>
      <td align="center">
        <img src="resource/image/PowerPC.png" width="290px"><br>
        <b>🔋 Керування живленням</b><br>
        Контролюйте параметри живлення ПК, включаючи вимкнення, перезавантаження і сплячий режим.
      </td>
    </tr>
  </table>
</div>

## ❓ Відеодемонстрація роботи > [Натисніть](https://vimeo.com/1013143950)
