  ...
  <table>
	<tr>
	  <td align="center">
		...
		<b>🔧 Зручна навігація між камерою чи робочим столом</b><br>
	  ...
	  <td align="center">
		...
		Спостерігайте за своїм робочим столом з телефона чи іншого ПК
	  </td>
	</tr>
    <tr>
      <td align="center">
    ...
    <tr>
      <td align="center">
        ...
        <b>🖥️ Панель навігації керування системою</b><br>
        Зручна навігація вашою системою.
      </td>
      <td align="center">
        <img src="resource/image/systemSection.png" width="290px"><br>
        <b>⚙️ </b><br>
        Взаємодійте з живленням ПК, змінюйте план електроживлення, функції блокування екрана, швидкого блокування, перевіряйте статуси диска, виходьте із системи.
      </td>
      <td align="center">
    ...
    <tr>
      <td align="center">
        ...
        Налаштовуйте та керуйте звуком вашого ПК дистанційно.
      </td>
      <td align="center">
        <img src="resource/image/devicecontrol.png" width="290px"><br>
        <b>🖱️ Керування пристроями</b><br>
        Дистанційно керуйте мишею та клавіатурою.
      </td>
      <td align="center">
        <img src="resource/image/checkweather.png" width="290px"><br>
        <b>🌤️ Перевірка погоди</b><br>
        Отримуйте актуальну інформацію про погоду прямо у боті!
      </td>
    </tr>
    <tr>
      <td align="center">
        <img src="resource/image/youtubecheck.png" width="290px"><br>
        <b>🎥 Запити YouTube</b><br>
        Шукайте контент на YouTube через Telegram.
      </td>
      <td align="center">
        <img src="resource/image/checkprocess.png" width="290px"><br>
        <b>🗂️ Керування процесами</b><br>
        Переглядайте та керуйте всіма запущеними процесами на вашому ПК, перевіряйте ресурси та завершуйте їх.
      </td>
      <td align="center">
        <img src="resource/image/browsercontrol.png" width="290px"><br>
        <b>🌐 Панель керування браузером</b><br>
        Керуйте діями в браузері, не виходячи з чату.
      </td>
    </tr>
  </table>
</div>
...
- **🚀 Запуск файлів:** Відкривайте будь-які файли з вашої директорії.
- **📥 Завантаження файлів:** Завантажуйте файли безпосередньо на ваш ПК.
- **📤 Завантаження файлів:** Завантажуйте файли з ПК в Telegram.
...
| **Linux**        | ❌                |                                                                                                                                                                           |                                                                                                                        |
| **MacOS**        | ❌                |                                                                                                                                                                           |                                                                                                                        |
| **Windows 7**    | ✔️                | 1. **Можливо виникне помилка:** `api-ms-win-core-path-l1-1-0.dll`. **Завантажте необхідний файл, щоб вирішити цю проблему.**<br>2. **Якщо додаєте програму до автозапуску, увімкніть її вручну в** `msconfig` > **Автозапуск.** | [Перейти за посиланням](https://github.com/Farmerok/Telegram-Remote-Control-PC/tree/main/docs/resource/files/for_WIndows-7) |
