  ...
  <table>
   <tr>
      <td align="center">
        ...
        <b>🔧 Удобная навигация между камерой или рабочим столом</b><br>
        Желаете за чем-нибудь понаблюдать? Выбирайте
      </td>
      <td align="center">
    ...
    <tr>
      ...
      <td align="center">
        ...
        Взаимодействуйте с питанием ПК, меняйте план электропитания, функция блока экрана, быстрого блока, проверка статусов диска, выход из системы.
      </td>
      <td align="center">
    ...
    <tr>
      <td align="center">
        ...
        <b>🎥 Запросы YouTube</b><br>
        Ищите контент на YouTube через Telegram.
      </td>
      <td align="center">
